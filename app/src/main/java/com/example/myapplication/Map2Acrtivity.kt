...
class Map2Acrtivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        autocompleteFragment.setOnPlaceSelectedListener(object : PlaceSelectionListener {
            ...
            override fun onError(status: com.google.android.gms.common.api.Status) {
                Toast.makeText(this@Map2Acrtivity, "Error al seleccionar lugar: ${status.statusMessage}", Toast.LENGTH_SHORT).show()
            }
        })
        ...
        btnSelectLocation.setOnClickListener {
            selectedLocation?.let { latLng ->
                ...
                if (addresses!!.isNotEmpty()) {
                    ...
                    intent.putExtra("selectedAddress", addressLine) // Identificador del fragmento a cargar
                    finish()
